      ...
      <div>
                ...
                properties.map((property, index) => (
                  <div key={category._id} className="flex gap-1 ">
                    <input
                      type="text"
                      value={property.name}
                      className=" rounded-xl px-2 mb-0"
                      onChange={(e) =>
        ...
        {!editedCategory && (
          <div className="font-semibold">
            {/* <div className="flex bg-slate-200 p-1 text-sm md:text-
            xl lg:text-2xl justify-between mt-2 rounded-md ">
              <div>Category </div>
              <div>Parent </div>
              <div>Action</div>
            </div> */}
            <table className="mt-4 w-full  text-sm md:text-xl  lg:text-2xl  ">
              <thead className="">
                <tr className=" bg-slate-200 ">
                  <td>Category name</td>
                  <td className="md:pl-6 lg:pl-20 xl:pl-32">Parent category</td>
                  <td className="flex justify-end  md:mr-10">Action</td>
                  <td></td>
                </tr>
              </thead>
              <tbody>
